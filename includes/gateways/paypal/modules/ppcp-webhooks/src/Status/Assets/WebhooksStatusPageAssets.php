	...
	public function get_script_data() {
		return array(
			'resubscribe' => array(
				...
				'failureMessage' => __( 'Operation failed. Check WooCommerce logs for more details.', 'woocommerce-for-japan' ),
			),
			'simulation'  => array(
				'start' => array(
				...
				'state' => array(
					...
					'waitingMessage'      => __( 'Waiting for the webhook to arrive...', 'woocommerce-for-japan' ),
					'successMessage'      => __( 'The webhook was received successfully.', 'woocommerce-for-japan' ),
					'tooLongDelayMessage' => __( 'Looks like the webhook cannot be received. Check that your website is accessible from the internet.', 'woocommerce-for-japan' ),
				),
			),
		);
	}
